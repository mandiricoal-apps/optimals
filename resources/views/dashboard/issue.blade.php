                ...
                <div class="col-lg-8 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-6 p-1">
                            <a href="/issue?status=open" class="py-3 form-control btn btn-{{ $status == 'open' ? 'info' : 'secondary' }}">Open</a>
                        </div>
                        <div class="col-lg-2 col-md-6 p-1">
                            <a href="/issue?status=progress" class="py-3 form-control btn btn-{{ $status == 'progress' ? 'info' : 'secondary' }}">Progress</a>
                        </div>
                        <div class="col-lg-2 col-md-6 p-1">
                            <a href="/issue?status=close" class="py-3 form-control btn btn-{{ $status == 'close' ? 'info' : 'secondary' }}">Closed</a>
                        </div>
                        <div class="col-lg-3 col-md-6 p-1">
                            <a href="/issue?status=reject" class="py-3 form-control btn btn-{{ $status == 'reject' ? 'info' : 'secondary' }}">Cancelled</a>
                        </div>
                    </div>
                </div>
