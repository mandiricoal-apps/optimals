            ...
            <div class="row mb-1 d-flex justify-content-between">
                <div class="col-lg-7 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12 p-1">
                            <a class="py-3 form-control btn btn-{{ $status == 'not-approved' ? 'info' : 'secondary' }}" href="/daily-inspection-area/{{ $area_id }}?status=not-approved">Not Approved</a>
                        </div>
                        <div class="col-lg-3 col-md-12 p-1">
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="row pl-2 pt-1 pr-0">
                        <x-filter_data url="{{ $status == 'not-approved' ? '/daily-inspection-area/' . $area_id . '?status=not-approved' : '/daily-inspection-area/' . $area_id . '?status=approved' }}" />
                    </div>
                </div>
