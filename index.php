...
<section class="">
				...
				<div class="col-md-4 login-sec">
					...
					<form class="login-form p-4">
						<div class="form-group">
							<label for="exampleInputEmail1" class=""><b><i class="mdi mdi-account menu-icon"></i> Username</b></label>
	...
	<style type="text/css">
		...
		.login-sec .copy-text i{color:#000;}
		.login-sec .copy-text a{color:#E36262;}
		.login-sec h2{margin-bottom:30px; font-weight:800; font-size:30px; color: #dc3545;}
		.login-sec h2:after{content:" "; width:100px; height:5px; background:#FEB58A; display:block; margin-top:20px; border-radius:3px; margin-left:auto;margin-right:auto}
		.btn-login{background: #0033c4; color:#fff; font-weight:600;}
		.banner-text{width:70%; position:absolute; bottom:315px; padding-left:20px;}
