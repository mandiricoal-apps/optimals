<div class="row">
	<div class="page-header p-0">
		<h3 class="page-title">Front Loading OB</h3>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Master Data</a></li>
				<li class="breadcrumb-item active" aria-current="page"> Data Question </li>
			</ol>
		</nav>
	</div>
	<div class="card">
			...
			<table id="example1" class="table table-striped table-hover" style="width:100%">
				...
				<tbody>
					<tr>
						...
						<td>Tinggi Jenjang Penggalian (Digging Bench Height)</td>
						<td>12</td>
						<td>1</td>
					...
					<tr>
						...
						<td>Kondisi Lantai Kerja Penggalian</td>
						<td>12</td>
						<td>2</td>
						<td class="text-center">
							<div class="button-group">
								...
								<button class="btn btn-success" data-toggle="modal" data-target="#edit-modal" disabled="">
									<i style="font-size: 14px;" class="mdi mdi-pencil-circle-outline"></i> Edit
								</button>
							</div>
						</td>
						...
						<form class="forms-sample" action="" target="">
							<div class="modal-body p-5">
								<div class="form-group">
									...
									<textarea type="text" class="form-control" id="" placeholder="Question" required=""></textarea>
								</div>
								<div class="form-group">
									<label for="">Weight</label><span style="color:red;">*</span>
									<input type="number" class="form-control" id="" placeholder="Weight" required="">
								</div>
								<div class="form-group">
									<label for="">Numbering</label><span style="color:red;">*</span>
									<input type="number" class="form-control" id="" placeholder="Numbering" required="">
								</div>
								<hr>
								<div class="row">
									<div class="col">
