        ...
        switch ($dailyInspection->area_id) {
            case 4:
                $dataLocation = [
                    ...
                    'BLOK' => $location->blok_start? $location->blok_start." - ":''  . $location->blok_end,
                    'STRIP' => $location->strip_start ? $location->strip_start." - ":''   . $location->strip_end,
                    'RL' => $location->rl? $location->rl." - ":''   . $location->rl_end,
                ];
                break;
            case 3:
                $dataLocation = [
