<div class="row">
	...
	<div class="page-header p-0">
		<h3 class="page-title">Dashboard Template</h3>
	...
	<div class="col-xl-4  p-3">
		<div class="card card-statx stretch-card mb-3">
			<div class="card-body">
		...
		<div class="card stretch-card mb-3">
			<div class="card-body d-flex flex-wrap justify-content-between" style="padding: 35px 28px">
				<div>
					<h4 class="font-weight-semibold mb-1 text-black"> Example </h4>
				...
				<div class="card border-0">
					...
					<div class="card-body mb-4">
						...
						<div class="d-flex flex-wrap">
							...
							<div id="doughnut-chart-legend2" class="pl-lg-6 rounded-legend align-self-center flex-grow legend-vertical legend-bottom-left"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card-body">
				...
				<div class="d-flex">
					...
					<div class="pl-4">
						...
						<h6 class="text-muted mb-0">Example</h6>
					</div>
				</div>
			</div>
		</div>
